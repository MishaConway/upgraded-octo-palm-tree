...
OpenGL::Buffer::Buffer( void* pData, const unsigned int data_size, GLenum buffer_type, GLenum usage )
{
...
bool OpenGL::Buffer::SetData( void* pData  )
{
...
GLuint OpenGL::Buffer::GetOpenGLBufferId(){
    return vbo_id;
}
